...
const Row:React.FC = () => {
    return (
        ...
        <Td isNumeric color="dark" fontSize="1rem"  fontWeight={600} lineHeight="1.21rem">$40,435.62</Td>
        <Td isNumeric>
          <Stack>
            <Text color="red" fontSize="1rem"  fontWeight={600} lineHeight="1.21rem">1,46%</Text>
          </Stack>
        </Td>
        <Td isNumeric>
          <Stack>
            <Text color="green" fontSize="1rem"  fontWeight={600} lineHeight="1.21rem">2.13%</Text>
          </Stack>
        </Td>
        <Td isNumeric color="dark" fontSize="1rem"  fontWeight={600} lineHeight="1.21rem">$768,904,009,242</Td>
      </Tr>
    )
}
